...
const pages = [
  ...
  {
    path: "pages/AuditDetail/AuditDetail",
    style: {
      navigationBarTitleText: "测评审核详情",
      enablePullDownRefresh: false,
      navigationBarBackgroundColor: "#FFE9EB"
    }
  },
  {
    path: "pages/AlreadyAdudit/AlreadyAdudit",
    style: {
  ...
  {
    path: "pages/AduditResult/AduditResult",
    style: {
      navigationBarTitleText: "审核结果详情",
      enablePullDownRefresh: false,
      navigationBarBackgroundColor: "#FFE9EB"
    }
  },
  {
    path: "pages/MyAuditList/MyAuditList",
    style: {
      navigationBarTitleText: "我的测评审核结果",
      enablePullDownRefresh: false,
      navigationBarBackgroundColor: "#FFE9EB"
    }
  },
  ...
  {
    path: "pages/ChangeUsername/ChangeUsername",
    style: {
