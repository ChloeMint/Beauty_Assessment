...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function auditProduct(status, token2) {
      network.createRequest("/product/examProduct", "PUT", {
        "Content-Type": "application/json",
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        r: !hide.value,
        s: common_vendor.o(($event) => pass(true)),
        t: common_vendor.o(($event) => pass(false))
      });
    };
  }
};
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-2bc4c793"], ["__file", "D:/uniappProgramme/Beauty/pages/AuditDetail/AuditDetail.vue"]]);
