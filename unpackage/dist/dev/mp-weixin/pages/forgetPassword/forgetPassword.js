...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function register() {
      ...
      network.createRequest("/user/forgetPassword", "POST", {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/uniappProgramme/Beauty/pages/forgetPassword/forgetPassword.vue"]]);
