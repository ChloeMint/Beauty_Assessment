  ...
  setup(__props) {
    ...
    function publish() {
      if (commentText.value == "") {
        ...
        network.createRequest("/test/addTextComment", "POST", {
          "Content-Type": "application/json",
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        m: !hide.value,
        n: common_vendor.o(($event) => hide.value = !hide.value),
        o: hide.value,
        p: common_vendor.o(($event) => hide.value = !hide.value),
        q: common_vendor.f(TestData.value.tests, (comment, k0, i0) => {
          return common_vendor.e({
            ...
            f: common_vendor.f(comment.image_list, (image, k1, i1) => {
              return {
        ...
        r: !hide.value,
        s: common_vendor.f(TestData.value.userComment, (comment, k0, i0) => {
          return {
            a: common_vendor.unref(base_url) + comment.user.avatar,
            b: common_vendor.t(comment.user.username),
            c: common_vendor.t(comment.publish_time),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-c5e4bbbf"], ["__file", "D:/uniappProgramme/Beauty/pages/ItemDetail/ItemDetail.vue"]]);
