<template>
	<view class="login-bg">
		...
		<view class="t-login">
			<view class="t-b">忘 记 密 码</view>
			<form class="cl">
				<view class="t-a">
					<image src="../../static/用户(绿).png"></image>
					<input type="number" name="phone" placeholder="请输入手机号码" maxlength="11" v-model="phone" />
				</view>
				
				<view class="t-a">
					<image src="../../static/密码(绿).png"></image>
					<input type="password" name="code"  placeholder="请输入新密码" v-model="pwdOne" />
				</view>
				...
				<button @click="register()">确 认</button>
			</form>
		</view>
		<view class="cardBox">
...
<script setup>
	...
	function register(){
		...
		createRequest("/user/forgetPassword","POST",{
...
<style>
	...
	.login-bg {
		height: 100vh;
		background: linear-gradient(to bottom, #7ebf4b, #54fe93);
	}
	...
	.t-login button {
		font-size: 28rpx;
		background: linear-gradient(to right, #7ebf4b, #54fe93);
		color: #fff;
		height: 90rpx;
		line-height: 90rpx;
		border-radius: 50rpx;
